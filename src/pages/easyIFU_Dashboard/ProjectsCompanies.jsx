...
import { companiesAction, projectsAction } from '../../redux/actions/supperAdminActions';

const ProjectsCompanies = () => {
  ...
  const {projectsRequest, projectsSuccess, projectsFail, allProjects} = projects;

console.log(projects)
console.log(projectsRequest, projectsSuccess, projectsFail)
  const dispatch = useDispatch()
  useEffect(() => {
    dispatch(projectsAction(token))
  },[])
  ...
  useEffect(() => {
    ...
    if(projectsFail){
        toast.warning(`${projectsFail.message}`)
      }
  },[projectsSuccess, projectsFail])
...
export default ProjectsCompanies