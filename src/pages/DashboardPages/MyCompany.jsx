...
} from "../../redux/actions/companyAcions";
...
const MyCompany = () => {
  ...
  const { companyRequest, companySuccess, companyFail, companyInfo } =
    getCompanyInfo;
  const {
  ...
  useEffect(() => {
    dispatch(
      getCompanyInfoAction(
        decodedToken && decodedToken.userInfo.companyId,
        token
      )
    );
  }, []);
          ...
          >
            ...
            >
              ...
              <button
                ...
                type="submit"
              >
                {!updateInfo ? "Update" : "Hide Form"}
              </button>
            </div>
            <div className="manage-user-card-content px-3 col-lg-8">
              <p style={{ fontSize: "14px", color: "gray" }}>
                Name: {companyState && companyState.companyName}{" "}
              </p>
              <p style={{ fontSize: "14px", color: "gray" }}>
                Address: {companyState && companyState.companyAddress}{" "}
              </p>
              <p style={{ fontSize: "14px", color: "gray" }}>
                Zip: {companyState && companyState.companyZip}{" "}
              </p>
              <p style={{ fontSize: "14px", color: "gray" }}>
                City: {companyState && companyState.companyCity}{" "}
              </p>
              <p style={{ fontSize: "14px", color: "gray" }}>
                Country: {companyState && companyState.companyCountry}{" "}
              </p>
              <p style={{ fontSize: "14px", color: "gray" }}>
                Phone: {companyState && companyState.companyPhone}{" "}
              </p>
              <div>
                subscription Info:
                <p
                ...
                {updateInfo && (
                  <form style={{ marginTop: "20px" }} onSubmit={handleSubmit}>
                    ...
                    <div className="text-center pt-1 mb-4 pb-1">
                      <button
                        disabled={updatedCompanyRequest ? true : false}
                        style={{
                          width: "100%",
                          backgroundColor: "#08408b",
                          border: "0",
