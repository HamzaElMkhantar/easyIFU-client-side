        ...
        <div className='mt-1'>
            ...
            ?<div>
                <div className='row' style={{display:'flex', justifyContent:'space-between', alignItems:'flex-start'}}>
                    ...
                    <div className='label-info-content-item' style={{display:'flex', justifyContent:'space-between', flexWrap:'wrap', gridGap:'10px', alignItems:'flex-start'}}>
                        {projectInfo && 
                            <div className='label-info-data' style={{flex:'0.6'}}>
