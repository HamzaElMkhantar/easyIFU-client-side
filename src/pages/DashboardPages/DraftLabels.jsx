...
const DraftLabels = () => {
  ...
  const {draftLabelsRequest, draftLabelsSuccess, draftLabelsFail, draftLabels} = drafLabels;

  const dispatch = useDispatch()
  useEffect(() => {
      dispatch(drafLabelsAction({companyId, productId, createdBy: userId},token))
  }, [])
  useEffect(() => {
