...
const Account = () => {
  ...
  return (
    ...
    >
      <SideBar isSidebarOpen={isSidebarOpen} updateUserSuccess={updateUserSuccess} />
        ...
        <section className="container" style={{ marginTop: "20px" }}>
          ...
          >
            ...
            <div className="manage-user-card-content px-3 col-lg-8">
              ...
              >
                Role:{" "}
                {userState?.role?.length > 1
                  ? userState?.role?.map((item) => (
                      <p className="mx-1"> {item},</p>
                    ))
                  : userState?.role?.map((item) => <p> {item} </p>)}{" "}
              </p>
              <p style={{ fontSize: "14px", color: "gray" }}>
              ...
              {userState?.createdAt && (
                <p style={{ fontSize: "14px", color: "gray" }}>
                  {" "}
                  Creation Date: {userState &&
                    dateFormat(userState?.createdAt)}{" "}
                </p>
              )}
            </div>
            {userRequest ? (
                      ...
                      <div>
                        <label>
                          <input
                            ...
                            type="checkbox"
                            id="Admin"
                            disabled={!userInfo.role.includes("Admin")}
                            // readOnly
