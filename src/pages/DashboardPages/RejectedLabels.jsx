...
const RejectedLabels = () => {
  ...
  const companyId =
    decodedToken && decodedToken.userInfo && decodedToken.userInfo.companyId;
  const userId =
  ...
  useEffect(() => {
    dispatch(
      rejectedLabelsAction({ companyId, productId, createdBy: userId }, token)
    );
  }, []);
  useEffect(() => {
    ...
    if (
      rejectedLabelsFail &&
      rejectedLabelsFail.message != "doesn't exist any label!"
    ) {
