...
const Project = () => {
  ...
  useEffect(() => {
    dispatch(
      getAllProjectsAction(companyId, decodedToken?.userInfo?._id, token)
    );
  }, []);
...
const renderButtonContent = (projectId) => {
  if (!deleteProjectRequest) {
    return <Delete style={{ color: "#CA0502", fontSize: "24px" }} />;
  }
  ...
  return (
    ...
    >
      ...
      <main className="" style={{ paddingTop: "0px", width: "100%" }}>
        {/* Dashboard header  */}
        <div style={{ position: "sticky", top: "0", zIndex:'1' }} id="page-content-wrapper">
          ...
          <Heading><Link className='linkStyle' to='/dashboard/project'>Projects</Link> /</Heading>
