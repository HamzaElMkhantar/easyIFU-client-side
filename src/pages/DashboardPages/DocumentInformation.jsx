    ...
    <div className="container pt-3">
        <div style={{display:'flex', justifyContent:'space-between', alignItems:'center'}}>
          ...
          <div className='document-content pt-4' >
           {!documentByIdRequest 
           ?<div ref={componentRef} className="A4-content" style={{display:'flex', flexWrap:'wrap', justifyContent:'space-evenly', alignItems:'flex-start'}}>
           {[...Array(5)].map((_, index) => (
             <img
               key={index}
               style={{ width: `${size}`, height: '', border: '1px solid black' }}
               className="card-img-top p-1 my-1"
